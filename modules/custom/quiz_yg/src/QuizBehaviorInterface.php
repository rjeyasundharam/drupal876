 ...
 */
interface QuizBehaviorInterface extends PluginFormInterface, ConfigurablePluginInterface {
   ...
   * @param \Drupal\quiz_yg\Entity\Paragraph $paragraph
   *   The paragraph.
  ...
  /**
   * Returns if the plugin can be used for the provided Quiz type.
   *
   * @param \Drupal\quiz_yg\Entity\QuizType $quiz_yg_type
   *   The Quiz type entity that should be checked.
   *
   * @return bool
