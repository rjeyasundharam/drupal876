...
namespace Drupal\quiz_yg\EventSubscriber;
...
class ReplicateFieldSubscriber implements EventSubscriberInterface {
  ...
  /**
   * Replicates quiz_yg when the parent entity is being replicated.
   *
  ...
  public function onClone(ReplicateEntityFieldEvent $event) {
    ...
    if ($field_item_list->getItemDefinition()->getSetting('target_type') == 'quiz_yg') {
