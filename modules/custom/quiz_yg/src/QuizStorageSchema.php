...
/**
 * Extends the quiz_yg schema handler.
 */
class QuizStorageSchema extends SqlContentEntityStorageSchema {
  ...
  protected function getEntitySchema(ContentEntityTypeInterface $entity_type, $reset = FALSE) {
    ...
    $schema['quiz_yg_item_field_data']['indexes'] += array(
      'quiz_yg__parent_fields' => array('parent_type', 'parent_id', 'parent_field_name'),
    );
