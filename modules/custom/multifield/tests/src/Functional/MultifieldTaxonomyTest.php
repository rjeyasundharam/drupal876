...
use Drupal\taxonomy\Entity\{Vocabulary,Term};
 ...
 * @group Multifield
 */
class MultifieldTaxonomyTest extends BrowserTestBase {
  ...
  protected function setUp() {
   ...
   $vocabulary = Vocabulary::create([
      'name' => "multifield_vocabulary",
      'description' => "Test Multifield Vocabulary",
      'vid' => "multifield_vocabulary",
    ...
    $term = Term::create([
      'name' => "multifield_term",
      'description' => [
        'value' => "multifield_term",
        'format' => $format->id(),
      ],
      'vid' => $vocabulary->id(),
      'langcode' => LanguageInterface::LANGCODE_NOT_SPECIFIED,
   ...
   $vocabulary = Vocabulary::create([
      'name' => "multifield_vocabulary1",
      'description' => "Test Multifield Vocabulary",
      'vid' => "multifield_vocabulary1",
      'langcode' => LanguageInterface::LANGCODE_NOT_SPECIFIED,
      'weight' => 0,
    ]);
    $vocabulary->save();
    ...
    $format = array_pop($filter_formats);
    $term = Term::create([
      'name' => "multifield_term1",
      'description' => [
        'value' => "multifield_term1",
        'format' => $format->id(),
      ],
      'vid' => $vocabulary->id(),
      'langcode' => LanguageInterface::LANGCODE_NOT_SPECIFIED,
  ...
  public function create_new_multifields(){
    ...
    $this->drupalGet('admin/add-fields/taxonomy_term/multifield_vocabulary');
  ...
  public function create_existing_fields() {
    ...
    $assert = $this->assertSession();
    $page=$this->getSession()->getPage();
    $this->drupalGet('admin/add-fields/taxonomy_term/multifield_vocabulary1');
    $assert->statusCodeEquals(200);
    $fields=[
      [ "label" => "A Text Field",  
