...
namespace Drupal\custom_quiz\Entity;

use Drupal\Core\Entity\EntityStorageInterface;
use Drupal\Core\Field\BaseFieldDefinition;
use Drupal\Core\Entity\ContentEntityBase;
use Drupal\Core\Entity\EntityTypeInterface;
use Drupal\custom_quiz\QuizInterface;
 ...
 *   You can see this in the entity.custom_quiz.canonical
 *   route in the custom_quiz.routing.yml file. The view can be
 ...
 * @ContentEntityType(
 *   id = "custom_quiz",
 *   label = @Translation("YG Quiz"),
 *   handlers = {
 *     "view_builder" = "Drupal\Core\Entity\EntityViewBuilder",
 *     "list_builder" = "Drupal\custom_quiz\Entity\Controller\QuizListBuilder",
 *     "form" = {
 *       "default" = "Drupal\custom_quiz\Form\QuizForm",
 *       "delete" = "Drupal\custom_quiz\Form\QuizDeleteForm",
 *     },
 *     "access" = "Drupal\custom_quiz\QuizAccessControlHandler",
 *   },
 ...
 *   },
 *   links = {
 *     "canonical" = "/custom_quiz/{custom_quiz}",
 *     "edit-form" = "/custom_quiz/{custom_quiz}/edit",
 *     "delete-form" = "/custom_quiz/{custom_quiz}/delete",
 *     "collection" = "/custom_quiz/list"
 *   },
 *   field_ui_base_route = "custom_quiz.quiz_settings",
 * )
 *
 ...
 *
 * Example: 'entity.custom_quiz.canonical'.
 *
 * See the routing file at custom_quiz.routing.yml for the
 * corresponding implementation.
 *
 * The Quiz class defines methods and fields for the quiz entity.
 *
 * Being derived from the ContentEntityBase class, we can override the methods
 * we want. In our case we want to provide access to the standard fields about
 * creation and changed time stamps.
 *
 * Our interface (see QuizInterface) also exposes the EntityOwnerInterface.
...
class Quiz extends ContentEntityBase implements QuizInterface {
  ...
  public static function baseFieldDefinitions(EntityTypeInterface $entity_type) {
    ...
    $fields['first_name'] = BaseFieldDefinition::create('string')
      ...
      ->setDescription(t('The first name of the Quiz entity.'))
      ->setSettings([
        'max_length' => 255,
        'text_processing' => 0,
      ])
    ...
    $fields['role'] = BaseFieldDefinition::create('list_string')
      ->setLabel(t('Role'))
      ->setDescription(t('The role of the Quiz entity.'))
      ->setSettings([
        'allowed_values' => [
